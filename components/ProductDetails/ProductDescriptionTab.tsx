...
import {ADDITIONAL_INFO_TAB_LABEL, DESCRIPTION_TAB_LABEL, REVIEWS_TAB_LABEL} from "../../config/productLabels";
    ...
    return (
        <div className="product-description-tab space-pt--r100 space-mt--r100 border-top--grey">
            <Tab.Container defaultActiveKey="description">
                ...
                >
                    <Nav.Item>
                        <Nav.Link eventKey="description">{DESCRIPTION_TAB_LABEL}</Nav.Link>
                    </Nav.Item>
                    {
                        product.variation && <Nav.Item>
                    ...
                    <Nav.Item>
                        <Nav.Link eventKey="reviews">
                            {REVIEWS_TAB_LABEL} {product.ratingCount ? `(${product.ratingCount})` : ""}
                        </Nav.Link>
                    </Nav.Item>
                </Nav>
                <Tab.Content>
